...
function enrollStudents(student,fetchstudents){
 ...
 enrollStudents({name : "shivam",age : 22},fetchStudents);




function enrollawaras(awara,fetchawaras){
    setTimeout(function(){
        awaras.push(awara)
        console.log("awaras has been enrolled")

    },5000)
 fetchawaras();
}

enrollawaras({name : "shivam",age : 22},fetchawaras);
